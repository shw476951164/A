...
public class RepairModel {
	@Plugin(name = "Model Repair-MA", parameterLabels = { "Petri net", "XLog" }, returnLabels = { "new pn" }, returnTypes = { Petrinet.class }, userAccessible = true, help = "This method is to repair an original model to a process model with free loop structures.")
